...
func (mainServer *MainServer) onReadClientData(client net.Conn, msg string) {
	...
	// 			// 如果是注册，保存
	// 		}
	// 	case message.MSGLoginIn:
	// 		{
	// 			// 如果登录成功, 则保存链接
	// 			if strings.Contains(result, "Ok") {
	// 				configer.ClientMap.Store(jsonReslut["user"], client)
	// 			}
	// 		}
	// 	case message.MSGLoginOut:
	// 		{
	// 			// 如果是登出, 则删除链接
	// 			if jsonReslut["user"] != nil {
	// 				configer.ClientMap.Delete(jsonReslut["user"])
	// 			}
	// 		}
	// 	case message.MSGFriendAdd:
	// 		{
	// 			// 将消息发送到对端。
	// 		}
	// 	case message.MSGFriendDel:
	// 		{
	// 			// 将消息发送到对端。
	// 		}
	// 	case message.MSGChat:
	// 		{
	// 			// 将消息发送到对端。
	// 		}
	// 	case message.MSGNewChatGroup:
	// 		{
	// 			// 将消息发送到对端。
	// 		}
	// 	case message.MSGUpdate:
	// 		{
